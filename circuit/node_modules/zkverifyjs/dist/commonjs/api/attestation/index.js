...
exports.subscribeToNewAttestations = subscribeToNewAttestations;
exports.unsubscribeFromNewAttestations = unsubscribeFromNewAttestations;
 ...
 */
function subscribeToNewAttestations(api, callback, attestationId) {
            ...
            if (event.section === 'poe' && event.method === 'NewAttestation') {
                ...
                if (attestationId) {
                    if (currentAttestationId > attestationId) {
                        emitter.emit(enums_1.ZkVerifyEvents.AttestationMissed, {
                    ...
                    if (currentAttestationId < attestationId) {
                        emitter.emit(enums_1.ZkVerifyEvents.AttestationBeforeExpected, {
                            expectedId: attestationId,
                            receivedId: currentAttestationId,
                            event: record.event,
                        });
                    ...
                    if (currentAttestationId === attestationId) {
                        ...
                        emitter.emit(enums_1.ZkVerifyEvents.AttestationConfirmed, attestationEvent);
 ...
 */
function unsubscribeFromNewAttestations(emitter) {

    ...
    if (typeof o === 'object' && o !== null) {
        ...
        for (const key in o) {
            if (Object.prototype.hasOwnProperty.call(o, key)) {
                result[key] = unstringifyBigInts(o[key]);
            }
        }
        return result;
    }
 ...
 */
export const getEndianess = (curve) => {
    return curve.toLowerCase() === 'bn254' ? 'LE' : 'BE';
};
/**
 * Extracts and normalizes curve type.
 */
export const extractCurve = (curve) => {
    if (curve === CurveType.bn128 || curve === CurveType.bn254)
        return 'bn254';
    if (curve === CurveType.bls12381)
        return 'Bls12_381';
 ...
 */
export const toHex = (value, length, endianess) => {
 ...
 */
export const formatG1Point = (point, endianess) => {
 ...
 */
export const formatG2Point = (point, endianess, curve) => {
    const [x1, x2, y1, y2] = [
        BigInt(point[0][0]),
        BigInt(point[0][1]),
        BigInt(point[1][0]),
    ...
    return (formatG1Point(formatX, endianess) +
        formatG1Point(formatY, endianess).slice(2));
};
/**
 * Formats a scalar as little-endian hexadecimal string.
 */
export const formatScalar = (scalar) => toHex(BigInt(scalar), 32, 'LE');
/**
 ...
 */
export const formatPublicSignals = (pubs) => {

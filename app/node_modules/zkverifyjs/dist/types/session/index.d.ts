...
import { OptimisticProofMethodMap } from './builders/optimisticVerify';
...
export declare class zkVerifySession {
     ...
     */
    constructor(connection: AccountConnection | WalletConnection | EstablishedConnection, customNetwork?: boolean);
    /**
     ...
     */
    format(proofOptions: ProofOptions, proof: unknown, publicSignals: unknown, vk: unknown, version?: string, registeredVk?: boolean): Promise<FormattedProofData>;
    /**

...
class zkVerifySession {
    ...
    createOptimisticVerifyBuilder(proofOptions) {
        return new optimisticVerify_2.OptimisticVerificationBuilder(this.executeOptimisticVerify.bind(this), proofOptions);
    }
    /**
    ...
    async executeOptimisticVerify(proofOptions, input) {
        ...
        return (0, optimisticVerify_1.optimisticVerify)(this.connection, proofOptions, input);
    }
    /**

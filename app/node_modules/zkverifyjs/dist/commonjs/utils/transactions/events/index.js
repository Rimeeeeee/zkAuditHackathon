...
const handleTransactionEvents = (api, events, transactionInfo, emitter, setAttestationId, transactionType) => {
    let statementHash;
    ...
    events.forEach(({ event, phase }) => {
        ...
        if (transactionType === enums_1.TransactionType.VKRegistration &&
            event.section == (0, helpers_1.getProofPallet)(transactionInfo.proofType) &&

...
exports.convertFeeToToken = convertFeeToToken;
 ...
 */
function convertFeeToToken(feeInSmallestUnit, decimals) {
 ...
 */
async function estimateCost(api, extrinsic, connection) {
    if (!connection.account) {
        throw new Error('Account information is required to estimate extrinsic cost.');
    }

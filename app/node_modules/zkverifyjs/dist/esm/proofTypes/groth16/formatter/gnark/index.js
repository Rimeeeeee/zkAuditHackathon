import { extractCurve, formatG1Point, formatG2Point, formatPublicSignals, getEndianess, unstringifyBigInts, } from '../utils';
/**
...
export const formatVk = (vk, options) => {
    try {
        ...
        return {
            curve,
            alpha_g1: formatG1Point([vkData.G1.Alpha.X, vkData.G1.Alpha.Y], endianess),
            ...
            gamma_abc_g1: vkData.G1.K.map((point) => formatG1Point([point.X, point.Y], endianess)),
        };
    }
    catch (error) {

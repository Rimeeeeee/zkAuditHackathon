...
async function verifyBid(bidAmount, tokenId, randomness, signerPrivateKey,commitment) {
 const {
         ZKV_RPC_URL,
         ZKV_SEED_PHRASE,
         ETH_RPC_URL,
         ...
         const { proof, publicSignals } = await snarkjs.groth16.fullProve(
             { b:bidAmount,r:randomness,v:commitment },
         ...
         appContract.once(filterAppEventsByCaller, async () => {
             console.log("App contract has acknowledged that you can verify!")
         })
}
